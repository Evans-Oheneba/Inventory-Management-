...
$sql = "SELECT computer_id, computer_serial_number, computer_name FROM mp_computers WHERE qr_code IS NULL";
...
while ($row = $result->fetch_assoc()) {
    ...
    $updateSQL = "UPDATE mp_computers SET qr_code = '$qrPath' WHERE computer_id = " . $row['computer_id'];
