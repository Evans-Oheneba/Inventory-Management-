   ...
   <!-- 🔹 Bootstrap Modal (Pop-Up Form) -->
    ...
    <div class="modal fade" id="assignAccessoryModal" tabindex="-1" aria-labelledby="assignModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="assignModalLabel">Assign Accessory</h5>
    ...
    $query = "SELECT equipment_name, equipment_serialNumber FROM equipment_received WHERE status = 'Available' AND equioment_type = 'Accessory'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO accessories (device_name, device_type, device_brand, device_serial_number, staff_assigned, staff_department, staff_office, staff_title, assigned_by, date_assigned, status, remarks) 
    ...
    if (mysqli_query($conn, $query)) {
        ...
        echo "<script>alert('Device Assigned Successfully!'); window.location.href='accessories.php';</script>";
    } else {
        echo "<script>alert('Error Assigning Device');</script>";
    }
}
?>
        <?php include('../generate_access_qr.php'); ?>
