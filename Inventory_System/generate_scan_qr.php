...
$sql = "SELECT device_id, device_serial_number, device_name FROM scanners_printers WHERE qr_code IS NULL";
...
while ($row = $result->fetch_assoc()) {
    ...
    $updateSQL = "UPDATE scanners_printers SET qr_code = '$qrPath' WHERE device_id = " . $row['device_id'];
